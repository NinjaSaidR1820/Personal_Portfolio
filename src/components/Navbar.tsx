...
export function Navbar() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-background/80 backdrop-blur-xl border border-border/50 p-2 rounded-full shadow-2xl flex items-center gap-1">
      {navItems.map((item) => {
