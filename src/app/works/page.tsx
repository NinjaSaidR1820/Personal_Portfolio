    ...
    <main className="min-h-screen bg-background py-24 px-6">
      <div className="container mx-auto max-w-5xl">
        <div className="mb-20 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black font-headline mb-4 italic text-foreground">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {impressiveWorks.map((work, idx) => (
            <Card key={idx} className="p-8 bg-card border-border hover:border-primary/50 transition-all hover:shadow-xl group rounded-[2rem]">
