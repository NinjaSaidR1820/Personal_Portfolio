...
export const metadata: Metadata = {
  title: 'Denis Said Rivas | Ingeniero en Sistemas, Desarrollador & IT Support',
...
export default function RootLayout({
  ...
  return (
    <html lang="es" className="scroll-smooth">
      ...
      <body className="font-body antialiased selection:bg-accent/30 selection:text-accent-foreground pb-24 sm:pb-0">
        <Navbar />
        {children}
      </body>
    </html>
